...
var1="El el perro perro corre corre rápido"
echo -e "\n${GREEN}ENCONTRAR PALABRAS REPETIDAS${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC} Palabras duplicadas consecutivas"
sleep 2
...
while true; do
    ...
    code=$(echo $?)
    r1=$(echo -e "$t1" | xargs)
    r_ok=$(echo "El el perro perro corre corre" | xargs)
