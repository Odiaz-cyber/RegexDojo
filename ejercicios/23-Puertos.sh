...
var1="Conexiones: 192.168.1.1:8080, 10.0.0.1:22, 8.8.8.8:443"
echo -e "\n${GREEN}TODOS LOS PUERTOS EN UN LOG${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC}Extraer los puertos"
sleep 2
