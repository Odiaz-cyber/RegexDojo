...
var1="Colores: #FF0000, #00FF00, #0000FF, #FFF"
echo -e "\n${GREEN}ENCONTRAR NÚMEROS HEXADECIMALES${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC} Códigos hex de 6 caracteres"
sleep 2
...
while true; do
    ...
    code=$(echo $?)
    r1=$(echo -e "$t1" | xargs)
    r_ok=$(echo "#FF0000 #00FF00 #0000FF" | xargs)
