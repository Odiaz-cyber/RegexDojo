...
var1="A1 Br2 C3 Dc4 E5 E."
echo -e "\n${GREEN}ENCONTRAR DÍGITOS EN POSICIÓN ESPECÍFICA${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC} Letra mayúscula seguida de número"
sleep 2
