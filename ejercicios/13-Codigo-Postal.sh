...
var1="Códigos: 28001, 08001, 41001, 99999, 00000"
echo -e "\n${GREEN}ENCONTRAR CÓDIGOS POSTALES${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC} Códigos de 5 dígitos que empiecen del 01-52"
sleep 2
...
while true; do
    ...
    code=$(echo $?)
    r1=$(echo -e "$t1" | xargs)
    r_ok=$(echo "28001 08001 41001" | xargs)
