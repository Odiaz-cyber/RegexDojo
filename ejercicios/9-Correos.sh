...
var1="Contactos: ana@gmail.com, juan@hotmail.es, pepe@yahoo.com.ar"
echo -e "\n${GREEN}ENCONTRAR CORREOS ELECTRÓNICOS${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC} Todos los emails válidos"
sleep 2
...
while true; do
    ...
    code=$(echo $?)
    r1=$(echo -e "$t1" | xargs)
    r_ok=$(echo "ana@gmail.com juan@hotmail.es pepe@yahoo.com.ar" | xargs)
