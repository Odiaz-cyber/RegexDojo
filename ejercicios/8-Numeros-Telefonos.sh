...
var1="Mis números: 123-4567, 555-1234 y 999-8888"
echo -e "\n${GREEN}ENCONTRAR NÚMEROS DE TELÉFONO${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC} Patrón de 3 dígitos, guión, 4 dígitos"
sleep 2
...
while true; do
    ...
    code=$(echo $?)
    r1=$(echo -e "$t1" | xargs)
    r_ok=$(echo "123-4567 555-1234 999-8888" | xargs)
