...
var1="192.168.1.10 - - [12/Jan/2025:15:30:45 +0000] GET /index.html"
echo -e "\n${GREEN}LOG DE APACHE - IP Y FECHA${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC}Extraer IP y fecha entre corchetes"
sleep 2
...
while true; do
    ...
    code=$(echo $?)
    r1=$(echo -e "$t1" | xargs)
    r_ok=$(echo "192.168.1.10 - - [12/Jan/2025:15:30:45 +0000]" | xargs)
