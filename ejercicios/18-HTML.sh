...
var1="<div><p>Texto</p></div><span>Otro</span>"
echo -e "\n${GREEN}EXTRAER ETIQUETAS HTML${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC}Todas las etiquetas HTML"
sleep 2
...
while true; do
    ...
    code=$(echo $?)
    r1=$(echo -e "$t1" | xargs)
    r_ok=$(echo "<div> <p> </p> </div> <span> </span>" | xargs)
