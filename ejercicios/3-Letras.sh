...
var1="casa casco cesto cisco cusco"
echo -e "\n${GREEN}ENCONTRAR LETRAS ESPECÍFICAS${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC} Palabras que empiecen con "c" y terminen con "o""
sleep 2
...
while true; do
    ...
    code=$(echo $?)
    r1=$(echo -e "$t1" | xargs)
    r_ok=$(echo "casco cesto cisco cusco" | xargs)
