...
var1="Horarios: 13:45, 00:00, 24:00, 25:61"
echo -e "\n${GREEN}ENCONTRAR HORAS EN FORMATO 24h${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC} Horas válidas (00-23) y minutos (00-59)"
sleep 2
...
while true; do
    ...
    code=$(echo $?)
    r1=$(echo -e "$t1" | xargs)
    r_ok=$(echo "13:45 00:00 24:00 25:61" | xargs)
