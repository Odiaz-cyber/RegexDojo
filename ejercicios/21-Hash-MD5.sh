...
var1="Hashes: 5d41402abc4b2a76b9719d911017c592, #12113edar321e3d13ew2redqwda"
echo -e "\n${GREEN}ENCONTRAR HASH MD5${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC}Hashes MD5 (32 caracteres hexadecimales)"
sleep 2
...
while true; do
    ...
    code=$(echo $?)
    r1=$(echo -e "$t1" | xargs)
    r_ok=$(echo "5d41402abc4b2a76b9719d911017c592" | xargs)
