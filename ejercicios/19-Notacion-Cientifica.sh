...
var1="Valores: 1.23e-4, 5.6E+8, 10e-2, .5E3"
echo -e "\n${GREEN}ENCONTRAR NÚMEROS EN NOTACIÓN CIENTÍFICA${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC}Números en notación científica"
sleep 2
...
while true; do
    ...
    code=$(echo $?)
    r1=$(echo -e "$t1" | xargs)
    r_ok=$(echo "1.23e-4 5.6E+8 10e-2 .5E3" | xargs)
