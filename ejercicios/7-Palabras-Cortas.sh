...
var1="Ser hacker es mi pasion pero soy un lammer "
echo -e "\n${GREEN}ENCONTRAR PALABRAS CORTAS${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC} Palabras de exactamente 2 letras"
sleep 2
