...
var1="URLS: https://www.google.com, http://github.com, ftp://servidor.local"
echo -e "\n${GREEN}EXTRAER URLS${NC}\n"
sleep 1
echo -e "${GREEN}Texto:${NC} $var1"
echo -e "${GREEN}Buscar:${NC} Las url de cada servicio"
sleep 2
...
while true; do
    ...
    code=$(echo $?)
    r1=$(echo -e "$t1" | xargs)
    r_ok=$(echo "https://www.google.com http://github.com ftp://servidor.local" | xargs)
